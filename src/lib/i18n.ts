...
export const dict: Record<Locale, Dict> = {
  fr: {
    ...
    "round.directorComment": "Commentaire du directeur (optionnel)",
    "round.directorCommentLabel": "Commentaire du directeur",
    "round.juryComment": "Commentaire du jury (optionnel)",
    "round.voteCommentPlaceholder": "Quelques mots sur ton vote…",
    "round.selectionTitle": "La sélection",
    "round.selectionCount": "{count} films",
    "round.selectionAnonymous":
      "Les commentaires ne sont pas signés : on découvre qui a proposé quoi à la cérémonie.",
    "round.ballotTitle": "Ton bulletin",
    "round.ballotProgress": "{done}/{total} catégories",
    "round.pickPlaceholder": "Choisir un film…",
    "round.pickNone": "à choisir",
    "round.yourFilmBadge": "Ton film",
    "round.yourFilmOut": "Hors bulletin : on ne vote pas pour soi.",
    "round.yourFilmNone":
      "Tu n'as rien soumis pour cette séance — tu peux quand même voter.",
    "round.yourFilmNoComment": "Tu n'avais pas laissé de commentaire.",
    "round.voteEditable": "Tes votes restent modifiables jusqu'à la cérémonie.",
  ...
  en: {
    ...
    "round.directorComment": "Director's note (optional)",
    "round.directorCommentLabel": "Director's note",
    "round.juryComment": "Jury's note (optional)",
    "round.voteCommentPlaceholder": "A few words about your vote…",
    "round.selectionTitle": "The selection",
    "round.selectionCount": "{count} films",
    "round.selectionAnonymous":
      "Notes are unsigned: who submitted what is revealed at the ceremony.",
    "round.ballotTitle": "Your ballot",
    "round.ballotProgress": "{done}/{total} categories",
    "round.pickPlaceholder": "Pick a film…",
    "round.pickNone": "to be picked",
    "round.yourFilmBadge": "Your film",
    "round.yourFilmOut": "Off the ballot: you cannot vote for yourself.",
    "round.yourFilmNone":
      "You did not submit anything for this screening — you can still vote.",
    "round.yourFilmNoComment": "You did not leave a note.",
    "round.voteEditable": "You can change your votes until the ceremony.",
