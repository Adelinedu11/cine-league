...
export const dict: Record<Locale, Dict> = {
  fr: {
    ...
    "login.codeSentTo": "Un code à 8 chiffres a été envoyé à {email}.",
    "login.codeLabel": "Code à 8 chiffres",
    "login.codePlaceholder": "12345678",
  ...
  en: {
    ...
    "login.codeSentTo": "An 8-digit code was sent to {email}.",
    "login.codeLabel": "8-digit code",
    "login.codePlaceholder": "12345678",
    "login.verify": "Verify",
